...
public class NodeAdd implements RobotExpressionNode {
	...
	public RobotExpressionNode parse(Scanner s) {
		...
		if (!Parser.gobble(Parser.ADD, s)) {
			Parser.fail("add fail. expecting: " + Parser.ADD.toString(), s);
		}
	...
	public String toString() {
		...
		return String.format("add ( %s, %s )", nodeA.toString(), nodeB.toString());
	}

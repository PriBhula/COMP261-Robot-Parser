...
public class NodeDiv implements RobotExpressionNode {
	...
	public RobotExpressionNode parse(Scanner s) {
		...
		if (!Parser.gobble(Parser.DIV, s)) {
			Parser.fail("div fail. expecting: " + Parser.DIV.toString(), s);
		}
	...
	public String toString() {
		...
		return String.format("div ( %s, %s )", nodeA.toString(), nodeB.toString());
	}
}
